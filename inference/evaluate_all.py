...
print("=" * 80)
print("EVALUATING MODEL ON ALL IMAGES IN DATASET")
print("=" * 80)

model_path = r'c:\Users\rajpu\Deepfake\Deepfake\inference\efficientnet_deepfake_ultra_final.h5'
data_dir = r'C:\Users\rajpu\OneDrive\Desktop\AI\inference\dataset'
threshold = 0.45
...
print("\n[PREPARING GENERATOR] Loading all images using optimized Keras generator...")
# ImageDataGenerator automatically uses bilinear interpolation for resizing to 224x224
# and preprocesses them for EfficientNet.
# Since these are 256x256 pre-cropped faces, they do not need Haar cascade double-cropping!
...
# Keras alphabetical order: fake -> 0, real -> 1
# This matches our true model mapping!
...
# Ensure true_classes is mapped correctly:
# In generator.class_indices: 'fake' is 0, 'real' is 1.
# Under our mapping: FAKE is 0, REAL is 1.
...
print("\n" + "=" * 80)
print("📊 COMPREHENSIVE PERFORMANCE RESULTS FOR ALL IMAGES")
print("=" * 80)
